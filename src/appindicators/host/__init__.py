...
from appindicators import watcher
from appindicators.dbusmenu import DBusMenu
from appindicators.dbusmenu.dbusmenu_gtk import DBusMenuGTK
...
class ItemProxy(dbus.Interface, gobject.GObject):
    ...
    def on_new_icon(self):
        self.cached_icon_filename = cached_property(self.get_icon_filename)
        self.emit('icon-new')

    def on_new_attention_icon(self):
        self.cached_attention_icon_filename = cached_property(self.get_attention_icon_filename)
